...
@NgModule({
  imports: [RouterModule.forRoot([{ path: 'success', component: SuccessComponent }, { path: 'error', component: ErrorComponent }, { path: 'auth-single-page', component: AuthFormComponent }, { path: 'register', component: RegisterFormComponent }, { path: 'auth-bcnd', component: AuthFormBcndComponent }]), SuccessComponentModule, ErrorComponentModule, AuthFormComponentModule, RegisterFormComponentModule, AuthFormBcndComponentModule],
